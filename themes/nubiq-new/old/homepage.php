...
<!--             <div class="cert-list">27001 | 27018</div> -->
    ...
    <section class="home-split side2">
      <div class="sec-img isoc" style="background-image: url('<?=wp_get_attachment_url($post_meta["nubiq_about_photo"])?>')">
      </div>
      <div class="sec-content">
        <div>
    ...
    <section class="home-split side1">
      <div class="sec-img isoc" style="background-image: url('<?=wp_get_attachment_url($post_meta["nubiq_services_photo"])?>')">
      </div>
      <div class="sec-content">
        <div>
    ...
    <section class="testimonials">
      ...
      <ul class="tdots">
<?php $quotes=get_posts(array("post_type"=>"nubiq_quotes", "posts_per_page"=>1000));
